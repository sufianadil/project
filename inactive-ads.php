			...
			<div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget user-dashboard-menu">
						<ul>
							<li><a href="dashboard.php"><i class="fa fa-user"></i> My Ads</a></li>
							<li><a href="active-ads.php"><i class="fa fa-bookmark-o"></i>Active Ads <span>
							</span></a></li>
							<li class="active"><a href="inactive-ads.php"><i class="fa fa-file-archive-o"></i>In-Active Ads <span>
							</span></a></li>
			...
			<div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
				...
				<div class="widget dashboard-container my-adslist">
					...
					<table class="table table-responsive product-dashboard-table">
						...
						<?php
						$sql = "SELECT p.status, p.file1, p.product_id, p.product_name, p.date, p.location,c.cat_name  FROM product p inner join category c on p.cat_id = c.cat_id WHERE p.customer_id =". $_SESSION["customer-login"];
						$result = mysqli_query($conn,$sql);
						if(mysqli_num_rows($result)>0){
						while($row=mysqli_fetch_assoc($result)){
						...
						<tbody>
							<tr>
								...
								<td class="product-thumb">
									<img width="80px" height="auto" src="product-images/<?php echo $row["file1"]; ?>" alt="image description"><br><br><a href="update-product-images.php?proid=<?php echo $row["product_id"];?>&action=update"><h4>Edit Image</h4></a></td>
									
								
								<td class="product-details">
									<h3 class="title"><?php echo $row["product_name"];?></h3>
									<span class="add-id"><strong>Ad ID:</strong><?php echo $row["product_id"];?></span>
									<span><strong>Posted on: </strong><time><?php echo $row["date"];?></time> </span>
									<span class="status active"><strong>Status</strong><?php echo $row["status"];?></span>
									<span class="location"><strong>Location</strong><?php echo $row["location"];?></span>
								</td>
