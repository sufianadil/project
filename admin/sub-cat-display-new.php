                            ...
                            <div class="col-md-12">                                
                                <div class="table-responsive">								 								 
                                   <table class="table table-striped table-hover table-md">
     										...
     										<tr>
                                            <th data-width="40">Sub_Category_ID</th>
                                            <th class="text-center">Category_Name</th>
											<th class="text-center">Sub_Category_Name</th>
										...
										<td class="text-center"><?php echo $row["sub_status"];?></td>
										<td class="text-center"><?php echo $row["time"];?></td>
    									<td  class="text-center"> <a href="sub-category-new.php?subcatid=<?php echo $row["sub_cat_id"];?>&action=delete">Delete</a> / 
										<a href="sub-category-new.php?subcatid=<?php echo $row["sub_cat_id"];?>&action=update">Edit</a></td>
  									</tr>
										<?php
										}
										}
